...
<SPLIT>
  ...
  VS_VERSION_INFO VERSIONINFO
    FILEVERSION    BROTLI_VERSION_MAJOR, BROTLI_VERSION_MINOR, BROTLI_VERSION_REVISION, 0
    PRODUCTVERSION BROTLI_VERSION_MAJOR, BROTLI_VERSION_MINOR, BROTLI_VERSION_REVISION, 0
    FILEFLAGSMASK  0x3fL
    FILEOS         0x40004L
    FILETYPE       0x2L
    FILESUBTYPE    0x0L
